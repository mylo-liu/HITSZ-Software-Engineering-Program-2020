...
public class MF_1_SubFunction_1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.mf_1_subfunction_1, container, false);
        ...
        btn_time = (Button) view.findViewById(R.id.btn_time_1);
        btn_category = (Button) view.findViewById(R.id.btn_category_1);
        btn_account = (Button) view.findViewById(R.id.btn_account_1);
        btn_member = (Button) view.findViewById(R.id.btn_member_1);
        edit_remark = view.findViewById(R.id.edit_remark_1);

        //-----输入金额-----
        edt_money = view.findViewById(R.id.edt_money_1);
        tv_pay = view.findViewById(R.id.tv_pay_1);
...
//                        .setCyclic(true, true, true)//循环与否
    ...
    private void getOptionData() {
         ...
         */
        //category_选项1
//        category_options1Items.add(new Bean(0, "工资"/*, "描述部分", "其他数据"*/));
//        category_options1Items.add(new Bean(1, "理财"/*, "描述部分", "其他数据"*/));
...
//        category_options2Items_01.add("日结");
//        category_options2Items_01.add("月结");
//        category_options2Items_01.add("兼职");
//        category_options2Items_01.add("年终奖");
//        ArrayList<String> category_options2Items_02 = new ArrayList<>();
//        category_options2Items_02.add("股票");
//        category_options2Items_02.add("基金");
//        category_options2Items_02.add("期货");
//        category_options2Items_02.add("其他");
//        ArrayList<String> category_options2Items_03 = new ArrayList<>();
//        category_options2Items_03.add("人情");
//        category_options2Items_03.add("礼金");
//        category_options2Items_03.add("其他");
