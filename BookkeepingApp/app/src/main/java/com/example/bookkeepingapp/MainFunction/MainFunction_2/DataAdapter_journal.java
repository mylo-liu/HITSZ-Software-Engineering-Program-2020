...
public class DataAdapter_journal extends RecyclerView.Adapter<DataAdapter_journal.ViewHolder> {

    private List<DataIn> mDataList;

    public DataAdapter_journal(List<DataIn> mDataList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (dataIn.getBill().equals("转账")) {
            ...
            holder.text_time.setText("时间：" + time);
            holder.text_money.setText(dataIn.getMoney()+" 元");
            holder.text_category.setText("类别：" + category);
